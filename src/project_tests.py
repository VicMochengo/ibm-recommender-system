...
df = pd.read_csv('D:\\personal_projects\\udacity_ds_nanodegree\\ibm_recommender_system_project\\data\\user-item-interactions.csv')
df_content = pd.read_csv('D:\\personal_projects\\udacity_ds_nanodegree\\ibm_recommender_system_project\\data\\articles_community.csv')
del df['Unnamed: 0']
